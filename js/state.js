...
export let gameState = {
  ...
  codeFeatures: {
    ...
    autoRun: false,
    variables: false,
    structures: false, // Arrays and Objects
    math: false, // Math library
    tabs: 1, // NEW: Start with 1 tab
  },
  userCode: {
    // Stores code for each tab
...
export const initializeUpgrades = () => {
  ...
  const createLand = (w, h, cost) => ({
    ...
    name: `Terreno ${w}x${h}`,
    effect: () => {
      gameState.gridSize = { width: w, height: h };
    },
  ...
  Object.assign(upgrades, {
    SPEED_1: {
      ...
      unlocked: false,
      cost: { WHEAT: 20 },
      name: "Turbo Drone I (1.5x)",
      effect: () => (gameState.drone.speedMultiplier = 1.5),
      description: "Aumenta a velocidade em 50%.",
    },
    SPEED_2: {
      category: "speed",
      unlocked: false,
      cost: { CARROT: 100, WHEAT: 100 },
      name: "Turbo Drone II (2x)",
      effect: () => (gameState.drone.speedMultiplier = 2),
      description: "Dobra a velocidade.",
    },
    SPEED_3: {
      category: "speed",
      unlocked: false,
      cost: { POTATO: 300, CARROT: 300 },
      name: "Turbo Drone III (3x)",
      effect: () => (gameState.drone.speedMultiplier = 3),
      description: "Triplica a velocidade.",
    },
    SPEED_MAX: {
      category: "speed",
      unlocked: false,
      cost: { STRAWBERRY: 2000 },
      name: "Teletransporte",
      effect: () => (gameState.drone.speedMultiplier = 10),
  ...
  Object.assign(upgrades, {
    CAP_1: {
      ...
      cost: { WHEAT: 10 },
      name: "Mochila (+50)",
      effect: () => (gameState.drone.inventoryCapacity += 50),
      description: "+50 Espaço",
    },
    CAP_2: {
      category: "capacity",
      unlocked: false,
      cost: { CARROT: 50 },
      name: "Caixa (+100)",
      effect: () => (gameState.drone.inventoryCapacity += 100),
      description: "+100 Espaço",
    },
    CAP_3: {
      category: "capacity",
      unlocked: false,
      cost: { POTATO: 150 },
      name: "Container I (+500)",
      effect: () => (gameState.drone.inventoryCapacity += 500),
      description: "+500 Espaço",
    },
    CAP_4: {
      category: "capacity",
      unlocked: false,
      cost: { CORN: 400 },
      name: "Container II (+1000)",
      effect: () => (gameState.drone.inventoryCapacity += 1000),
      description: "+1000 Espaço",
    },
    CAP_5: {
      category: "capacity",
      unlocked: false,
      cost: { TOMATO: 1000 },
      name: "Silo Portátil (+5000)",
      effect: () => (gameState.drone.inventoryCapacity += 5000),
      description: "+5000 Espaço",
    },
    CAP_6: {
      category: "capacity",
      unlocked: false,
      cost: { WATERMELON: 5000 },
      name: "Buraco Negro (+10k)",
      effect: () => (gameState.drone.inventoryCapacity += 10000),
      description: "+10.000 Espaço",
    },
    CAP_7: {
      category: "capacity",
      unlocked: false,
      cost: { STRAWBERRY: 10000 },
      name: "Armazém Quântico (+50k)",
      effect: () => (gameState.drone.inventoryCapacity += 50000),
      description: "+50.000 Espaço",
    },
  });
  ...
  Object.assign(upgrades, {
    CODE_TAB_2: {
      ...
      cost: { CORN: 200 },
      name: "Console 2",
      effect: () => (gameState.codeFeatures.tabs = 2),
      description: "Desbloqueia aba 2.",
    },
    CODE_TAB_3: {
      category: "code",
      unlocked: false,
      cost: { TOMATO: 500 },
      name: "Console 3",
      effect: () => (gameState.codeFeatures.tabs = 3),
      description: "Desbloqueia aba 3.",
    },
    CODE_TAB_4: {
      category: "code",
      unlocked: false,
      cost: { STRAWBERRY: 1000 },
      name: "Console 4",
      effect: () => (gameState.codeFeatures.tabs = 4),
      description: "Desbloqueia aba 4.",
    },
    CODE_VARIABLES: {
      category: "code",
      unlocked: false,
      cost: { WHEAT: 25 },
      name: "Memória: Variáveis",
      effect: () => (gameState.codeFeatures.variables = true),
      description: "Habilita o uso de let, const e var.",
    },
    CODE_STRUCTURES: {
      category: "code",
      unlocked: false,
      cost: { CARROT: 75 },
      name: "Memória: Coleções",
      effect: () => (gameState.codeFeatures.structures = true),
      description: "Habilita o uso de Arrays [] e Objetos {}.",
    },
    CODE_MATH: {
      category: "code",
      unlocked: false,
      cost: { POTATO: 100 },
      name: "Biblioteca: Math",
      effect: () => (gameState.codeFeatures.math = true),
      description: "Habilita a biblioteca Math do JavaScript.",
    },
    CODE_COND: {
      category: "code",
      unlocked: false,
      cost: { WHEAT: 50 },
      name: "Condicionais",
      effect: () => (gameState.codeFeatures.conditionals = true),
      description: "Habilita if/else.",
    },
    CODE_FUNC: {
      category: "code",
      unlocked: false,
      cost: { CARROT: 100 },
      name: "Funções",
      effect: () => (gameState.codeFeatures.functions = true),
      description: "Habilita funções.",
    },
    CODE_LOOP: {
      category: "code",
      unlocked: false,
      ...
      description: "Habilita loops.",
    },
    CODE_AUTO: {
      category: "code",
      unlocked: false,
      cost: { BELL_PEPPER: 200 },
      name: "Auto Run",
      effect: () => (gameState.codeFeatures.autoRun = true),
  ...
  Object.assign(upgrades, {
    WATER_1: {
      ...
      cost: { WHEAT: 20 },
      name: "Galão (+10)",
      effect: () => (gameState.waterCapacity += 10),
      description: "+10 Capacidade de Água.",
    },
    WATER_2: {
      category: "water",
      unlocked: false,
      cost: { CARROT: 50 },
      name: "Tanque (+20)",
      effect: () => (gameState.waterCapacity += 20),
      description: "+20 Capacidade de Água.",
    },
    WATER_3: {
      category: "water",
      unlocked: false,
      cost: { POTATO: 150 },
      name: "Cisterna (+50)",
      effect: () => (gameState.waterCapacity += 50),
      description: "+50 Capacidade de Água.",
    },
    WATER_4: {
      category: "water",
      unlocked: false,
      cost: { CORN: 400 },
      name: "Caixa d'Água (+100)",
      effect: () => (gameState.waterCapacity += 100),
      description: "+100 Capacidade de Água.",
    },
    WATER_5: {
      category: "water",
      unlocked: false,
      cost: { TOMATO: 1000 },
      name: "Reservatório (+500)",
      effect: () => (gameState.waterCapacity += 500),
      description: "+500 Capacidade de Água.",
    },
    WATER_MAX: {
      category: "water",
      unlocked: false,
      cost: { WATERMELON: 5000 },
      name: "Oceano Portátil (+5k)",
      effect: () => (gameState.waterCapacity += 5000),
      description: "+5000 Capacidade de Água.",
    },
    ...
    RAIN_1: {
      ...
      unlocked: false,
      cost: { WHEAT: 50 },
      name: "Dança da Chuva (+5%)",
      effect: () => (gameState.rainChance += 5),
      description: "Total 10% Chance de Chuva.",
    },
    RAIN_2: {
      category: "water",
      unlocked: false,
      cost: { CARROT: 100 },
      name: "Totem da Tempestade (+10%)",
      effect: () => (gameState.rainChance += 10),
      description: "Total 20% Chance de Chuva.",
    },
    RAIN_3: {
      category: "water",
      unlocked: false,
      cost: { POTATO: 200 },
      name: "Controle Climático (+10%)",
      effect: () => (gameState.rainChance += 10),
      description: "Total 30% Chance de Chuva.",
    },
    RAIN_MAX: {
      category: "water",
      unlocked: false,
      cost: { CORN: 500 },
      name: "Satélite Meteorológico (+10%)",
      effect: () => (gameState.rainChance += 10),
      description: "Total 40% Chance de Chuva.",
    },
  });
  ...
  Object.assign(upgrades, {
    UNLOCK_BOTS: {
      category: "robotics",
      unlocked: false,
      cost: { WHEAT: 500, CORN: 200, CARROT: 200 },
      name: "Fábrica de Robôs",
      effect: () => (gameState.botFarm.unlocked = true),
      description: "Desbloqueia a Área dos Robôs.",
    },
    BOT_LIMIT_1: {
      category: "robotics",
      unlocked: false,
      cost: { TURNIP: 300 },
      name: "Expansão de Núcleo I",
      effect: () => (gameState.botFarm.maxRobots += 1),
      description: "+1 Slot de Robô.",
    },
    BOT_LIMIT_2: {
      category: "robotics",
      unlocked: false,
      cost: { TOMATO: 600 },
      name: "Expansão de Núcleo II",
      effect: () => (gameState.botFarm.maxRobots += 1),
      description: "+1 Slot de Robô.",
    },
    BOT_LIMIT_3: {
      ...
      unlocked: false,
      cost: { PUMPKIN: 1000 },
      name: "Expansão de Núcleo III",
      effect: () => (gameState.botFarm.maxRobots += 2),
      description: "+2 Slots de Robô.",
    },
    BOT_LIMIT_4: {
      category: "robotics",
      unlocked: false,
      cost: { WATERMELON: 2500 },
      name: "Expansão de Núcleo IV",
      effect: () => (gameState.botFarm.maxRobots += 2),
      description: "+2 Slots de Robô.",
    },
    BOT_LIMIT_5: {
      category: "robotics",
      unlocked: false,
      cost: { STRAWBERRY: 5000 },
      name: "Mainframe IA",
      effect: () => (gameState.botFarm.maxRobots += 5),
      description: "+5 Slots de Robô.",
    },
    BOT_SPEED_1: {
      category: "robotics",
      unlocked: false,
      ...
      effect: () => (gameState.botFarm.speedMultiplier += 0.5),
      description: "Robôs 50% mais rápidos.",
    },
    BOT_SPEED_2: {
      category: "robotics",
      unlocked: false,
      cost: { PUMPKIN: 1500 },
      name: "Servos Hidráulicos",
      effect: () => (gameState.botFarm.speedMultiplier += 1.0),
      description: "Robôs 100% mais rápidos.",
    },
  });
  ...
  Object.assign(upgrades, {
    UNLOCK_CARROT: {
      ...
      effect: () => {
        ...
        gameState.dropChances.CARROT_SEED = 20;
      },
      description: "Libera Cenouras (20% Drop).",
    },
    UNLOCK_POTATO: {
      category: "seeds",
      unlocked: false,
      cost: { CARROT: 30 },
      name: "Desbloquear Batata",
      effect: () => {
        gameState.unlockedCrops.push("POTATO");
        gameState.dropChances.POTATO_SEED = 20;
      },
      description: "Libera Batatas (20% Drop).",
    },
    UNLOCK_PEPPER: {
      category: "seeds",
      unlocked: false,
      cost: { POTATO: 60 },
      name: "Desbloquear Pimentão",
      effect: () => {
        gameState.unlockedCrops.push("BELL_PEPPER");
        gameState.dropChances.BELL_PEPPER_SEED = 20;
      },
      description: "Libera Pimentões (20% Drop).",
    },
    UNLOCK_CORN: {
      category: "seeds",
      unlocked: false,
      cost: { BELL_PEPPER: 100 },
      name: "Desbloquear Milho",
      effect: () => {
        gameState.unlockedCrops.push("CORN");
        gameState.dropChances.CORN_SEED = 20;
      },
      description: "Libera Milho (20% Drop).",
    },
    UNLOCK_TURNIP: {
      category: "seeds",
      unlocked: false,
      cost: { CORN: 150 },
      name: "Desbloquear Nabo",
      effect: () => {
        gameState.unlockedCrops.push("TURNIP");
        gameState.dropChances.TURNIP_SEED = 20;
      },
      description: "Libera Nabos (20% Drop).",
    },
    UNLOCK_TOMATO: {
      category: "seeds",
      unlocked: false,
      ...
      effect: () => {
        ...
        gameState.dropChances.TOMATO_SEED = 20;
      },
      description: "Libera Tomates (20% Drop).",
    },
    UNLOCK_PUMPKIN: {
      category: "seeds",
      unlocked: false,
      cost: { TOMATO: 400 },
      name: "Desbloquear Abóbora",
      effect: () => {
        gameState.unlockedCrops.push("PUMPKIN");
        gameState.dropChances.PUMPKIN_SEED = 20;
      },
      description: "Libera Abóboras (20% Drop).",
    },
    UNLOCK_WATERMELON: {
      category: "seeds",
      unlocked: false,
      cost: { PUMPKIN: 600 },
      name: "Desbloquear Melancias",
      effect: () => {
        gameState.unlockedCrops.push("WATERMELON");
        gameState.dropChances.WATERMELON_SEED = 20;
      },
      description: "Libera Melancias (20% Drop).",
    },
    UNLOCK_STRAWBERRY: {
      category: "seeds",
      unlocked: false,
      cost: { WATERMELON: 1000 },
      name: "Desbloquear Morangos",
      effect: () => {
        gameState.unlockedCrops.push("STRAWBERRY");
        gameState.dropChances.STRAWBERRY_SEED = 20;
      },
      description: "Libera Morangos (20% Drop).",
    },
  });
...
export function saveGame() {
  const unlockedUpgradeIds = Object.keys(gameState.upgrades).filter(
    (id) => gameState.upgrades[id].unlocked,
  );
...
export function loadGame() {
  ...
  try {
    ...
    if (data.doubleHarvestChance)
      gameState.doubleHarvestChance = data.doubleHarvestChance;
